...
class __Templates__1c4c96f66cc96a601cdac625123c65fe extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE2e29561fbe1ec880bf80733e3800209($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionE2e29561fbe1ec880bf80733e3800209(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                $context->push($value);
                if ($partial = $this->mustache->loadPartial('this_table')) {
                    $buffer .= $partial->renderInternal($context, $indent . '							');
                }
                $context->pop();
            }
